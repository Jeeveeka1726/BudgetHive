...
const FooterPrimaryDarkTheme = () => {        
    return (
        <section className="py-10 bg-green-70 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p className="text-base leading-relaxed text-gray-600 mt-7">BudgetHive – Empowering businesses with seamless expense tracking and AI-driven financial insights for smarter decisions.</p>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Contact Support </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> User Guide </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Feature Requests </a>
                    </li>
                </ul>
            </div>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" className="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-black rounded-md hover:bg-black ">Subscribe</button>
                </form>
            </div>
        </div>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by BudgetHive</p>
    </div>
</section>

    )
}
export default FooterPrimaryDarkTheme;